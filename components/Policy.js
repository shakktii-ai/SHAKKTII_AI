...
export default function PrivacyPolicy() {
  ...
  return (
     <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      ...
      {/* Modal Box */}
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white shadow-2xl rounded-xl">
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-6">
      <div className="max-w-4xl mx-auto bg-white shadow rounded-xl p-8 md:p-12">
...
<h1 className="text-md font-bold  text-gray-900">
        ...
        <p>No refunds are entertained as it is a service based website.</p>
             </div>
      </div>
    </div>
    </div></div>
