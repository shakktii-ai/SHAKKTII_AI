  ...
  return (
    ...
    >
      ...
      {isMobile ? (
        ...
        /* ORIGINAL DESKTOP VIEW (Kept exactly as provided) */
        <div className="relative w-full h-[673px] mx-auto flex items-center justify-center scale-[0.45] sm:scale-[0.6] md:scale-[0.75] lg:scale-[0.85] xl:scale-100 origin-center transition-transform duration-500 overflow-visible">
          {/* STRAIGHT HORIZONTAL DIVIDER */}
          {/* <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100vw] h-[1px] bg-black opacity-40 z-10" /> */}
          ...
          <motion.button
            onClick={handlePrev}
            disabled={isBackDisabled}
            style={{ left: 'calc(50% - 401.5px)', top: '378px', width: '44px', height: '43px', background: '#FF7046', position: 'absolute', zIndex: 40, x: '-50%' }}
